...
Optimized with efficient computations and smoothing.
"""
...
class SpeedEstimator:
    ...
    def estimate(self, detections: List[Dict], frame: np.ndarray,
        ...
        for det in detections:
            ...
            # Calculate speed
            speed = self._estimate_speed_for_track(track_id, current_pos, frame.shape)
    ...
    def _estimate_speed_for_track(self, track_id: int, current_pos: Tuple[int, int],
        ...
        # Optical flow for small displacements
    ...
    def _get_optical_flow_speed(self, position: Tuple[int, int]) -> float:
        ...
        return flow_magnitude * self.calibration_factor * 3.6
